...
public class changepass extends javax.swing.JFrame {
    ...
    private void jPasswordField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPasswordField1ActionPerformed
        password2=jPasswordField1.getText();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(password1!="" && password2!=""){
            if(password1.equals(password2)){
                try{
                    user check=new user();
                    boolean door=check.changepass(password1, username);
                    if(door){
                        JOptionPane.showMessageDialog(null, "changed your password  ", "OKEY", JOptionPane.WARNING_MESSAGE);
                    }
                }catch(Exception e){
                 ...
                 JOptionPane.showMessageDialog(null, "dont same your password!  ", "Alert", JOptionPane.WARNING_MESSAGE);
            }
        }
        else{
             JOptionPane.showMessageDialog(null, "Please do not leave blank space!  ", "Alert", JOptionPane.WARNING_MESSAGE);
        }
        int secenek = JOptionPane.showConfirmDialog(null, "Would you like to go back ?");
